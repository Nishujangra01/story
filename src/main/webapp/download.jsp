  ...
  margin: 20px;
    ...
    <body>
       ...
       <%@include file="component/navbar.jsp" %>
        ...
        <div id="divvv" class="mydiv">
                 <h3 id="dowmh3"> </h3>   
                          </div>
                           
                          <script>
                               var s="cccccccccccccc"; 
                                    var h3=document.getElementById("dowmh3").innerHTML=s;
                               var element = document.getElementById("divvv").appendedNode( h3);
